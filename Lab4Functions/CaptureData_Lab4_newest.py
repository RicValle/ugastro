    ...
    while not terminate_flag.is_set():
        ...
        try:
            ...
            try:
                ...
                ts_print("[DataThread] Data captured. Performing FFT and pushing to Save queue...")
                ...
                for device_index, raw_data in raw_data_dict.items():
                    ...
                    ts_print(f"[DataThread] Device {device_index}: FFT done, pushed to save queue.")
                ...
                ts_print(f"[DataThread] Exception during capture or FFT: {e}")
...
if __name__ == "__main__":
    ...
    threading.Thread(target=data_thread, args=(sdr_list, noise_diode, data_queue, save_queue, log_queue, terminate_flag), name="DataThread", daemon=True).start()
