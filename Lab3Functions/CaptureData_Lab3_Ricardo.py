...
# ======= DATA COLLECTION ======= #
BUFFER_LIMIT = 1000 #Test Code 1: Setting a buffer limit (Test more)
            ...
            if "acc_cnt" in data:
                ...
                with data_lock:
                    ...
                    if len(data_buffer) >= BUFFER_LIMIT:
                        ...
                        log_message(f"Buffer limit reached. Data saved to disk.  Buffer size: {len(data_buffer)}")
                        data_buffer.clear()
